  ...
  useEffect(() => {
      const fetchTasks = async () => {
        try {
          ...
          const response = await fetch(`http://127.0.0.1:8000/topic/${topicId}/tasks`, {
            method: "POST",
  ...
  return (
    <div>
      <div className="header">
        <h1><a href="/"><span className="highlight">StudyWeave</span> - "{topicName}" Kanban</a></h1>
