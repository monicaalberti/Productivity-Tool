...
* If it is your first time setting up the application, create a Python virtual environment `python -m venv env-name` or activate your existing one `source env-name/bin/activate`
